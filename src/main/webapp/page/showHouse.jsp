...
<DL class=clearfix>
  ...
  <DIV class=box>
    <FORM id=add_action method=post enctype="multipart/form-data" action=updateOne>
      <DIV class=infos>
        <TABLE class=field>
          <TBODY>
          <TR>
          ...
          <TR>
          <TR>
            <TD class=field>标　　题：<INPUT id=d class=text value="${house.id}" type=hidden name=id></TD>
  ...
  <TR>
          <TR>
            ...
            <TD> <INPUT id=pics class=text type=hidden name=delimage value="${house.path}"><img src="http://localhost:80/${house.path}" height="50" width="40" /><INPUT id=pic class=text type=file name=pfile> </TD></TR>
          <TR>
    <TD class=field>详细信息：</TD>
    <TD><TEXTAREA name=description>${house.description}</TEXTAREA></TD></TR></TBODY></TABLE>
        <DIV class=buttons><INPUT  value=更新 type=submit></DIV></DIV></FORM></DIV></DIV></DIV>
