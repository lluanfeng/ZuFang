...
<DL class=clearfix>
    ...
    <FORM id=add_action method=post enctype="multipart/form-data" action=addHouse>
      <DIV class=infos>
        <TABLE class=field>
          ...
          <TR>
            <TD><INPUT id=a class=text type=hidden name=ispass value="0"> </TD></TR>
          <TR>
            <TD><INPUT id=b class=text type=hidden name=isdel value="0"> </TD></TR>
          <TR>
  ...
  <TR>
    ...
    <TD><TEXTAREA name=description></TEXTAREA></TD></TR></TBODY></TABLE>
        <DIV class=buttons><INPUT  value=立即发布 type=submit></DIV></DIV></FORM></DIV></DIV></DIV>
